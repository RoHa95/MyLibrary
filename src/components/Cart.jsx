  ...
  return (
    <div className='w-80 h-110 border border-indigo-800 rounded-xs  flex flex-col items-center justify-between my-6 hover:bg-indigo-50'>
        ...
        <div>
            ...
            <span className=''> سالار مگس ها </span>
        </div>
        <div>
            <span className='text-indigo-800'> نویسنده : </span>
            <span> ویلیام گلدینگ </span>
        </div>
        <div>
            <span className='text-indigo-800'>ژانر : </span>
            <div className='flex items-center justify-start gap-x-1'>
                <span className='text-xs text-indigo-800 bg-indigo-100 rounded-md px-1 pb-1.5'>رمان </span>
                <span className='text-xs text-indigo-800 bg-indigo-100 rounded-md px-1 pb-1.5'> داستان خارجی </span>
                <span className='text-xs text-indigo-800 bg-indigo-100 rounded-md px-1 pb-1.5'>برنده نوبل </span>
            </div>
        </div>
        <AddToQoue/>
        </div>
